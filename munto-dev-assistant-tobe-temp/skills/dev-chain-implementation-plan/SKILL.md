...
특히 **무인 모드 (PHASE 2 무인)** 진입은 *IP 사람 리뷰 통과 + Operating Mode 의 Kill Switch 명시 + Slack 알림 정책 확정* 3 가지 모두 통과해야만 허용. 자세한 절차는 [TO-BE 프로세스 가이드 (Notion)](https://www.notion.so/Agentic-Dev-Chain-Munto-TO-BE-36de2bc7639d8052b13fc49575c10e56) §4.9 참조.
