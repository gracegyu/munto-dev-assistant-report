...
- 본 파일 위치 (기획 미러, 적용 대기):    munto-dev-assistant-tobe-temp/skills/munto-spec-writer/SKILL.md (임시 GitHub 레포: https://github.com/Munto-dev/munto-dev-assistant-tobe-temp)
