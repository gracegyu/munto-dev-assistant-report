...
### TO-BE 가 AS-IS 대비 추가/강화한 것 (요점 7 가지)
...
| 7 | **AI 시대 행동 패턴을 막는 4 가지 검증 메커니즘** *(NEW)* | *"AI 가 썼으니 내 책임 아님 / 모르는 용어 그냥 넘기기 / 1 안 통과"* 3 가지 함정을 막는 ① 책임 전환 원칙 ② 자기점검 체크리스트 ③ Glossary 의무화 ④ 대안 검토 강제 *(§3 강조 박스 참조)* |

### 우리 팀이 *오늘부터* 다르게 해야 할 일 — 4 줄
